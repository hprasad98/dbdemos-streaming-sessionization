...
# MAGIC <img width="1px" src="https://ppxrzfxige.execute-api.us-west-2.amazonaws.com/v1/analytics?category=data-engineering&org_id=923710833314495&notebook=%2F03-Delta-session-GOLD&demo_name=streaming-sessionization&event=VIEW&path=%2F_dbdemos%2Fdata-engineering%2Fstreaming-sessionization%2F03-Delta-session-GOLD&version=1">
...
wait_for_table("retail_hari_prasad.events") #Wait until the previous table is created to avoid error if all notebooks are started at once
...
# MAGIC %sql
# MAGIC SELECT * FROM retail_hari_prasad.sessions
